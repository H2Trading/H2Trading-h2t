# Kaufvertrag über ein gebrauchtes Nutzfahrzeug
...
Gegenstand dieses Kaufvertrags ist das nachfolgend bezeichnete Fahrzeug einschließlich sämtlicher **zum Zeitpunkt der Übergabe** im Fahrzeug verbauter oder mit dem Fahrzeug übergebener Systeme, Aggregate, Aufbauten und technischer Einbauten.

**Fahrzeugdaten:**

Fahrzeugtyp: _______________________________  
Hersteller / Modell: ________________________  
...
4. Der Verkäufer erklärt, dass ihm zum Zeitpunkt des Vertragsabschlusses keine ihm bekannten wesentlichen Mängel des Fahrzeugs bekannt sind, die einer Übergabe entgegenstehen, und dass er ihm bekannte Umstände, die für die Kaufentscheidung wesentlich sind, offengelegt hat.  
   Diese Erklärung erfolgt nach bestem Wissen und ohne Übernahme einer Garantie oder Gewährleistung.
...
1. Der Kaufpreis beträgt:
   ...
   EUR ____________________ netto

2. Allfällige gesetzliche Steuern werden – sofern anwendbar – zusätzlich verrechnet oder sind vom Käufer im Bestimmungsland zu entrichten.

---

## § 4 Zahlungsmodalitäten und Ablauf
...
Die Gefahr geht mit Übergabe oder – sofern vereinbart – mit der Verladung des Fahrzeugs auf den Käufer über.

---

## § 6 Rolle eines allfälligen Vermittlers

1. Ein allfälliger Vermittler ist nicht Vertragspartei dieses Kaufvertrags.

2. Der Vermittler übernimmt keine Haftung für:
   - Zustand, Beschaffenheit oder Werthaltigkeit des Kaufgegenstands  
   - Richtigkeit und Vollständigkeit der Angaben des Verkäufers  
   - Zahlungsfähigkeit oder Zahlungswilligkeit des Käufers
